...
const IconChevronDown = () => (
  <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#8ab4c7" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
    <polyline points="6 9 12 15 18 9" />
  </svg>
)

/* ─── Wood Circle ───────────────────────────────────────────── */
const WoodCircle = ({ Icon, label, isTop = false }) => {
  ...
  return (
    <>
      <style>{`
        ...
        .cc-reg-input:focus, .cc-reg-select:focus {
        ...
        .cc-signin-link:hover { text-decoration-color: #1baac8 !important; }
      ...
      <div style={styles.page}>
        ...
        <div style={styles.leftPanel} className="cc-left-panel">
          ...
          <div style={styles.headingBlock}>
            ...
            <p style={styles.subheading}>Join ClaimCore and manage your claims effortlessly.</p>
          </div>
          ...
          <form style={styles.form} onSubmit={handleSubmit} noValidate>
            ...
            <div style={styles.fieldGroup}>
              ...
              <div style={styles.inputWrapper}>
                <span style={styles.inputIcon}><IconRole /></span>
                <select
                  id="role"
                  name="role"
                  value={form.role}
                  onChange={handleChange}
                  onFocus={() => setInputFocus(f => ({ ...f, role: true }))}
                  onBlur={() => setInputFocus(f => ({ ...f, role: false }))}
                  style={{ ...styles.select, ...focusStyle('role') }}
                  className="cc-reg-select"
                >
                  <option value="patient">Patient</option>
                  <option value="insurer">Insurer</option>
                </select>
                <span style={{ position: 'absolute', right: '14px', pointerEvents: 'none', display: 'flex' }}>
                  <IconChevronDown />
                </span>
              </div>
            </div>
        ...
        <div style={styles.rightPanel} className="cc-right-panel">
          ...
          <div style={styles.circleGrid}>
            <div style={{ ...styles.circleRow, marginBottom: '-8px' }}>
              <WoodCircle Icon={IconShieldCheck} label="PROTECTION" isTop />
            </div>
          ...
          <div style={styles.pillsRow}>
            {['🔒 Secure', '⚡ Fast Claims', '24/7 Support'].map(text => (
